...
<head>
        ...
        <!-- Title -->
        <meta name="twitter:title" content="Resultados — FlyNeves">
        <meta property="og:title" content="Resultados — FlyNeves">
        <!---->
        <!-- description -->
        <!-- URL -->
        <link rel="canonical" href="https://www.flyneves.com/pt-BR/pesquisando-no-site/">
        <meta property="og:url" content="https://www.flyneves.com/pt-BR/pesquisando-no-site/">
        <meta name="twitter:url" content="https://www.flyneves.com/pt-BR/pesquisando-no-site/">
        <!---->
        <!-- Author(s) -->
            ...
            <div class="default-background-image">
                <div id="section-main">
                    <section class="important-content-section">
                        <h2>
                            <span>
                            Resultados para: <?php echo $userSearch; ?>
                            </span>
                        </h2>
                        ...
                        <div class="text-and-icon">
                            ...
                            <strong>Páginas importantes</strong>
                        </div>
                        <div class="text-and-icon">
                 ...
                 <section class="important-content-section">
                    <header>
                        <h3 class="subtitles-main access-search-pages-title">
                            <span>
                            Páginas com outros resultados da pesquisa:
                            </span>
                        </h3>
                    </header> 
