    <article class="important-content-section">
        <header>
            <h1>
                Propriedade currentLine
            </h1>
        </header>
        <div>
            <p>
            A linha no campo de texto onde o caret está posicionado.
            </p>
            ...
            <p>
            Um número inteiro indicando a linha na qual o caret está posicionado.
            </p>
            <h2 class="subtitles-main">
                <span>
                    Syntax
            ...
            <div class="code-example">
                <pre><code>
                var currentLine = textFieldRange( element ).currentLine;
                </code></pre>
            </div>
            <h2 class="subtitles-main">
                <span>
