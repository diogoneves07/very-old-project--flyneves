<article class="important-content-section">
    <header>
        <h1>
            Propriedade currentLineEnd
        </h1>
    </header>
    <p>
    A posição do último caractere da linha no campo de texto onde o caret está posicionado.    </p>
    ...
    <p>
    Um inteiro indicando a posição do último caractere na linha.
    </p>
    <h2 class="subtitles-main">
        <span>
            Syntax
