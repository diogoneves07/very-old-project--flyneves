...
<header>
    ...
    <p>
    Insere uma sequência de caracteres em uma determinada posição no campo de texto.    </p>
    ...
    <p>
        Este argumento é obrigatório. Especifica a posição onde a sequência de caracteres deve ser inserida.
    </p>
    <h4 class="subtitle-marked">
        <span>
            string
    ...
    <p>Este argumento é opcional. Especifica se a nova sequência de caracteres deve ser selecionada.</p>
    <h3 class="subtitles-main">
        <span>
            Valor de retorno
        </span>
    ...
    <div class="code-example">
        <pre><code>
        textFieldRange( element ).appendString( 0, "string", true );
        </code></pre>
    </div>
    <h2 class="subtitles-main">
        <span>
