<article class="important-content-section">
    ...
    <p>
        Este argumento é obrigatório. Específica o ouvinte a ser anexado ao objeto da animação.
    </p>

    <p class="text-expected-type-of-data">Tipo esperado: <strong>string</strong>.</p>
    <p>
    ...
    <p class="text-expected-type-of-data">Tipo esperado: <strong>function</strong>.</p>
    <p>
