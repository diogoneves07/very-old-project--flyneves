...
<html lang="pt-BR" id="article">
    <head>
        ...
        <!---->
        <title>
            Introdução – controlAnimationJS | FlyNeves
        </title>
        <!-- Title -->
        <meta name="twitter:title" content="Introdução – controlAnimationJS | FlyNeves">
        <meta property="og:title" content="Introdução – controlAnimationJS | FlyNeves">
        <!---->
        <!-- description -->
        ...
        <!---->
        <!-- URL -->
        <link rel="canonical" href="https://www.flyneves.com/pt-BR/projetos/controlAnimationJS/1.0/">
        <meta property="og:url" content="https://www.flyneves.com/pt-BR/projetos/controlAnimationJS/1.0/">
        <meta name="twitter:url" content="https://www.flyneves.com/pt-BR/projetos/controlAnimationJS/1.0/">
        <!---->
        <!-- hreflang -->
        <link rel="alternate" href="https://www.flyneves.com/en-US/projects/controlAnimationJS/1.0/" hreflang="en-US">
        <!---->
        <!-- Others(s) -->
