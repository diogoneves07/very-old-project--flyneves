    ...
    <html id="article" lang="en-US"><head>
            ...
            <!---->
            <title>
                controlAnimationJS library – controlAnimationJS | FlyNeves
            </title>
            <!-- Title -->
            <meta name="twitter:title" content="controlAnimationJS library – controlAnimationJS | FlyNeves">
            <meta property="og:title" content="controlAnimationJS library – controlAnimationJS | FlyNeves">
            <!---->
            <!-- description -->
            ...
            <!-- URL -->
            <link rel="canonical" href="https://www.flyneves.com/en-US/projects/controlAnimationJS/1.0/documentation/introduction/">
            <meta property="og:url" content="https://www.flyneves.com/en-US/projects/controlAnimationJS/1.0/documentation/introduction/">
            <meta name="twitter:url" content="https://www.flyneves.com/en-US/projects/controlAnimationJS/1.0/documentation/introduction/">
            <!---->
            <!-- hreflang -->
            <link rel="alternate" href="https://www.flyneves.com/pt-BR/projetos/controlAnimationJS/1.0/documentacao/introducao/" hreflang="pt-BR">
            <!---->
            <!-- Others(s) -->
