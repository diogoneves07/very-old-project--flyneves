<article class="important-content-section">
    <header>
        ...
        <p>
        At the beginning of the animation if you define a value for this property, it will be respected, that is, the animation will start from the defined value.        </p>
        ...
        <div class="code-example">
            <pre><code>
            myAnimationObject.progress = 100;
            </code></pre>
        </div>
        <h2 class="subtitles-main">
            <span>
