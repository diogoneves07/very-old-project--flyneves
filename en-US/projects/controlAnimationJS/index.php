...
<html id="other" lang="en-US">
    <head>
        ...
        <!---->
        <title>
            Versions – controlAnimationJS | FlyNeves
        </title>
        <!-- Title -->
        <meta name="twitter:title" content="Versions – controlAnimationJS | FlyNeves">
        <meta property="og:title" content="Versions – controlAnimationJS | FlyNeves">
        <!---->
        <!-- description -->
        <meta name="description" content="On this page, you will find links to all versions of the controlAnimationJS library.">
        <meta name="twitter:description" content="On this page, you will find links to all versions of the controlAnimationJS library.">
        <meta property="og:description" content="On this page, you will find links to all versions of the controlAnimationJS library.">
        <!---->
        <!-- URL -->
        <link rel="canonical" href="https://www.flyneves.com/en-US/projects/controlAnimationJS/">
        <meta property="og:url" content="https://www.flyneves.com/en-US/projects/controlAnimationJS/">
        <meta name="twitter:url" content="https://www.flyneves.com/en-US/projects/controlAnimationJS/">
        <!---->
        <!-- hreflang -->
       <link rel="alternate" href="https://www.flyneves.com/pt-BR/projetos/controlAnimationJS/" hreflang="pt-BR">
        <!---->
        <!-- Others(s) -->
