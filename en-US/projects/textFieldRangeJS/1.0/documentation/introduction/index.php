    ...
    <html id="article" lang="en-US"><head>
            ...
            <!---->
            <title>
                textFieldRangeJS Library – textFieldRangeJS | FlyNeves
            </title>
            <!-- Title -->
            <meta name="twitter:title" content="textFieldRangeJS Library – textFieldRangeJS | FlyNeves">
            <meta property="og:title" content="textFieldRangeJS Library – textFieldRangeJS | FlyNeves">
            <!---->
            <!-- description -->
            ...
            <!-- URL -->
            <link rel="canonical" href="https://www.flyneves.com/en-US/projects/textFieldRangeJS/1.0/documentation/introduction/">
            <meta property="og:url" content="https://www.flyneves.com/en-US/projects/textFieldRangeJS/1.0/documentation/introduction/">
            <meta name="twitter:url" content="https://www.flyneves.com/en-US/projects/textFieldRangeJS/1.0/documentation/introduction/">
            <!---->
            <!-- hreflang -->
            <link rel="alternate" href="https://www.flyneves.com/pt-BR/projetos/textFieldRangeJS/1.0/documentacao/introducao/" hreflang="pt-BR">
            <!---->
            <!-- Others(s) -->
