<article class="important-content-section">
    <header>
        <h1>
             textFieldWidth property
        </h1>
    </header>
    <p>
    The width of the text entry field.    </p>
    ...
    <p>
    The text entry field is the frame of the element where the text can be added.
    </p>
    <h2 class="subtitles-main">
        <span>
            Syntax
    ...
    <div class="code-example">
        <pre><code>
            var textFieldWidth = textFieldRange( element ).textFieldWidth;
        </code></pre>
    </div>
    <h2 class="subtitles-main">
        <span>
