<article class="important-content-section">
    ...
    <p>
    Replaces the string selected in the text field.
    </p>
    ...
    <p>This argument is optional. Specifies whether the new string is to be selected.</p>
    ...
    <div class="code-example">
        <pre><code>
            textFieldRange( element ).replaceSelection( "string" );
        </code></pre>
    </div>
    <h2 class="subtitles-main">
        <span>
