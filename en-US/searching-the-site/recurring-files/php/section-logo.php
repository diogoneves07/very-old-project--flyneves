<div class="section-in-highlight">
        ...
        <p>
        O FlyNeves é um site com intuito compartilhar experiências; desenvolvimento de bibliotecas, algoritmos e projetos Open-source, para WEB e outras tecnologias. 
        </p>
        <section class="section-in-highlight-other">
        <nav class="library-start-links">
            <ul>
                <li>
                    <a href="<?php echo $pathToSiteDirectories->languageDirectory; ?>projetos/">
                        Projetos
                    </a>
                </li>
                <li>
                    <a href="<?php echo $home; ?>documentação">
                        Doar
                    </a>
                </li>
                <li>
